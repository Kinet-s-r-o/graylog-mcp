...
for _button_html, _action_html in (
    ('<button onclick="openServerModal()">+ Add server</button>', '<div class="section-heading-actions"><a class="section-help" href="/ui/help" target="_blank" rel="noopener" title="Open help">?</a><button onclick="openServerModal()">+ Add server</button></div>'),
    ('<button onclick="openAgentModal()">+ Add client</button>', '<div class="section-heading-actions"><a class="section-help" href="/ui/help" target="_blank" rel="noopener" title="Open help">?</a><button onclick="openAgentModal()">+ Add client</button></div>'),
    ('<button onclick="openRuleModal()">+ Add rule</button>', '<div class="section-heading-actions"><a class="section-help" href="/ui/help" target="_blank" rel="noopener" title="Open help">?</a><button onclick="openRuleModal()">+ Add rule</button></div>'),
):
...
UI_HTML = UI_HTML.replace('</script></body></html>', MANAGEMENT_JS + FILTER_JS + TABLE_FILTER_JS + TABLE_FILTER_PATCH_JS + FILTER_POSITION_JS + LOGOUT_JS + AUDIT_FILTER_JS + AUDIT_DEDUP_JS + NAVIGATION_FIX_JS + AUDIT_INIT_JS + '</script></body></html>')
