...
UI_HTML = UI_HTML.replace('</script></body></html>', MANAGEMENT_JS + FILTER_JS + TABLE_FILTER_JS + TABLE_FILTER_PATCH_JS + FILTER_POSITION_JS + LOGOUT_JS + AUDIT_FILTER_JS + AUDIT_DEDUP_JS + AUDIT_INIT_JS + '</script></body></html>')
